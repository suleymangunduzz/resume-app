...
export async function getServerSideProps() {
  const fetchExperience = fetch(`${__BASE_API_URL__}/experience`).then(res => res.json());
  ...
  return { props: { data: experiences.sort((a, b) => b.order - a.order), tabs: tabs.sort((a, b) => a.order - b.order) } }
}
